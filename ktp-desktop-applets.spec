...
Version  : 19.08.1
Release  : 12
URL      : https://download.kde.org/stable/applications/19.08.1/src/ktp-desktop-applets-19.08.1.tar.xz
Source0  : https://download.kde.org/stable/applications/19.08.1/src/ktp-desktop-applets-19.08.1.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.1/src/ktp-desktop-applets-19.08.1.tar.xz.sig
...
%prep
%setup -q -n ktp-desktop-applets-19.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567712037
mkdir -p clr-build
pushd clr-build
