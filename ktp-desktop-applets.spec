...
Version  : 18.12.3
Release  : 5
URL      : https://download.kde.org/stable/applications/18.12.3/src/ktp-desktop-applets-18.12.3.tar.xz
Source0  : https://download.kde.org/stable/applications/18.12.3/src/ktp-desktop-applets-18.12.3.tar.xz
Source99 : https://download.kde.org/stable/applications/18.12.3/src/ktp-desktop-applets-18.12.3.tar.xz.sig
...
%prep
%setup -q -n ktp-desktop-applets-18.12.3
...
export LANG=C
export SOURCE_DATE_EPOCH=1555357117
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
